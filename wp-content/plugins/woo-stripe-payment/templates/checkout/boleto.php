...
<div id="wc_stripe_local_payment_<?php echo $gateway->id ?>" data-active="<?php echo $gateway->is_local_payment_available() ?>">
	...
	<?php if ( wc_stripe_mode() === 'test' ): ?>
        <div class="wc-stripe-boleto__description">
            <p><?php _e( 'Test mode values', 'woo-stripe-payment' ) ?></p>
            <div>
	...
	<?php else: ?>
        <div class="wc-stripe-boleto__description">
            <p><?php _e( 'Accepted formats', 'woo-stripe-payment' ) ?></p>
            <div>
                <label>CPF:</label>&nbsp;<span><?php _e( 'XXX.XXX.XXX-XX or XXXXXXXXXXX', 'woo-stripe-payment' ) ?></span>
            </div>
            <div>
                <label>CNPJ:</label>&nbsp;<span><?php _e( 'XX.XXX.XXX/XXXX-XX or XXXXXXXXXXXXXX', 'woo-stripe-payment' ) ?></span>
            </div>
        </div>
	<?php endif; ?>
</div>